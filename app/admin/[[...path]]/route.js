...
<head>
  ...
  <meta name="viewport" content="width=device-width,initial-scale=1,viewport-fit=cover">
  <meta name="robots" content="noindex,nofollow">
  <title>Yönetici Paneli | No.11 Pilates Studio</title>
  <link rel="stylesheet" href="/no11-admin-exact-20.css?v=20260915-live-date-hit-1" data-no11-premium="1">
</head>
<body>
  <main id="n11-admin-boot"></main>
  ...
  <script src="/no11-admin-firebase.js?v=20260921-self-contained" defer></script>
...
async function proxy(request) {
  ...
  if (request.method === 'GET' || request.method === 'HEAD') {
    return new Response(request.method === 'HEAD' ? null : adminPage(), {
      status: 200,
      headers: {
        'content-type': 'text/html; charset=utf-8',
        'cache-control': 'no-store, no-cache, must-revalidate',
