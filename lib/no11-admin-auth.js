...
const PREVIEW_SESSION_KEY = '119c0fbcf7be2511b14dd0a7ee839ba35b999425818864de0ae0444292b60a87';
const SESSION_TTL_SECONDS = 60 * 60 * 24 * 7;
const TEMP_ADMIN_OPEN = false;

function secret() {
  const configured = String(process.env.NO11_ADMIN_API_KEY || '').trim();
  if (configured) return configured;
  return process.env.VERCEL_ENV === 'preview' ? PREVIEW_SESSION_KEY : '';
}
