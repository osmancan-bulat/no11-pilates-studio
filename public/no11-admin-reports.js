(function(){
  ...
  function checkReady(){
    ...
    var toast=document.createElement('button');toast.className='n11-rp-ready';toast.innerHTML='<b>Günlük raporunuz hazır, Eda Hanım.</b><span>Bugünün özetini görüntüleyin →</span>';toast.onclick=function(){toast.remove();renderReport()};document.body.appendChild(toast);setTimeout(function(){if(toast.parentNode)toast.remove()},12000);
  }
